...
#cur.execute("insert into paymentsf values(1,'Bhvah Shree ','Bansal','1111111111','xyz@gmail.com',2,'1','11','2023','11:20:27 PM','Cash','3500')")
...
spath = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/mypic.jpg"
...
Label(sroot,text="Bhvah Shree Bansal",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="xyz@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("Cloud Performing tuning Project")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	path = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/newestbg5.jpg"
	...
	def hotel_status():
		...
		path = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/newbg6lf.jpeg"
		img = ImageTk.PhotoImage(Image.open(path))
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Cloud Performing Tuning Project',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		path = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/newbg6lf.jpg"
		img = ImageTk.PhotoImage(Image.open(path))
		label = Label(b_frame,image = img ,height=400,width=1080)
		label.image=img
		label.place(x=0,y=0)
		...
		'''
		emp1f = Frame(b_frame)
		path1 = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/newman.jpg"
		...
		Label(emp1inf,text="Mr. gautam bhatt ",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		emp1f = Frame(b_frame)
		path2 = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/receptionnew.jpg"
		...
		emp1f = Frame(b_frame)
		path3 = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/fchefnew.jpg"
		...
		emp1f = Frame(b_frame)
		path4 = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/roomservicenew.jpg"
		...
		b_frame.pack_propagate(False)
		b_frame.tkraise()
		nl = Label(b_frame,text='Cloud Performance tuning Project',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()
	...
	path = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/rooms.png"
	img = ImageTk.PhotoImage(Image.open(path))
	b1 = Button(sl_frame,image=img,text='b1',bg='white',width=180,command=rooms)
	b1.image = img
	b1.place(x=180,y=0)
	path2 = "C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/hotelstatus.png"
	img1 = ImageTk.PhotoImage(Image.open(path2))
	b2 = Button(sl_frame,image=img1,text='b2',bg='white',width=180,command=hotel_status)
	b2.image = img1
	b2.place(x=0,y=0)
	path3='C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/guests.png'
	img3 = ImageTk.PhotoImage(Image.open(path3))
	b3 = Button(sl_frame,image=img3,text='b2',bg='white',width=180,command=staff)
	b3.image = img3
	b3.place(x=180*4,y=0)
	path4='C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/payments.png'
	img4 = ImageTk.PhotoImage(Image.open(path4))
	b4 = Button(sl_frame,image=img4,text='b2',bg='white',width=180,command = payments)
	b4.image = img4
	b4.place(x=180*3,y=0)
	path5='C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/logout.png'
	...
	path6='C:/Users/DELL/Desktop/cpt project/hotel-management-system-master/images/Bookroom.png'
